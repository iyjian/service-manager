...
- Kubernetes container icons open/focus multiple closable bottom Logs/Shell workspace tabs keyed by namespace/Pod/container/type. Drawer close preserves tabs; Context/page/shutdown cleanup closes them. Leaving the Kubernetes tab stops Watches, logs, and terminal sessions, while explicit port forwards remain until their Context lifecycle ends.
