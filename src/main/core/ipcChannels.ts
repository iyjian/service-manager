export const IPC_CHANNELS = {
  localTerminalOpen: 'local-terminal:open',
  localTerminalWrite: 'local-terminal:write',
  localTerminalResize: 'local-terminal:resize',
  localTerminalClose: 'local-terminal:close',
  localTerminalAcknowledge: 'local-terminal:acknowledge',
  localTerminalState: 'local-terminal:state',
  localTerminalOutput: 'local-terminal:output',
  ...
  sshTerminalAcknowledge: 'ssh-terminal:acknowledge',
  sshTerminalState: 'ssh-terminal:state',
  sshTerminalOutput: 'ssh-terminal:output',
  listHosts: 'host:list',
  saveHost: 'host:save',
  ...
  noteShareSettingsGet: 'settings:notes:share:get',
  noteShareSettingsSave: 'settings:notes:share:save',
  noteShareSettingsReveal: 'settings:notes:share:reveal-shortener',
  ...
  notesSyncCheck: 'notes:sync-check',
  notesUploadOnLeave: 'notes:upload-on-leave',
  notesSyncAllowOffline: 'notes:sync-allow-offline',
  notesSyncGuardState: 'notes:sync-guard-state',
