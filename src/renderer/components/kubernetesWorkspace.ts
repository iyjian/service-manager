...
export { clampWorkspaceHeight as clampKubernetesWorkspaceHeight } from './workspaceResize.js';
...
export function createKubernetesWorkspace(options: KubernetesWorkspaceOptions): KubernetesWorkspace {
  ...
  const workspaceResize = createWorkspaceResize({ ...options, onResize: () => terminalPane.resizeActive() });
  const applyWorkspaceHeight = workspaceResize.applyHeight;
  const workspacePageHeight = workspaceResize.pageHeight;
  const syncWorkspaceResizeAttributes = workspaceResize.sync;
  const finishWorkspaceResize = workspaceResize.finish;
