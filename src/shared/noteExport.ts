...
export function buildNotePrintDocument(title: string, bodyHtml: string): string {
  return `<!doctype html><html><head><meta charset="utf-8"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src 'unsafe-inline'"><title>${escapeHtml(title)}</title><style>
    @page{size:A4;margin:18mm 17mm 20mm}*{box-sizing:border-box}body{margin:0;color:#18181b;font-family:Inter,"Noto Sans SC",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;font-size:11pt;line-height:1.65;overflow-wrap:anywhere}h1.title{margin:0 0 1.25em;padding-bottom:.45em;border-bottom:1px solid #e4e4e7;font-size:24pt;line-height:1.2}h1,h2,h3,h4,h5,h6{break-after:avoid;line-height:1.3;margin:1.2em 0 .45em}p{margin:.5em 0}a{color:#2563eb;text-decoration:underline}pre{white-space:pre-wrap;word-break:break-word;background:#f4f4f5;border:1px solid #e4e4e7;border-radius:6px;padding:10px;break-inside:avoid}code,.math{font-family:"JetBrains Mono",ui-monospace,SFMono-Regular,Consolas,monospace;background:#f4f4f5;border-radius:3px;padding:.1em .25em}pre code{background:transparent;padding:0}blockquote{margin:.8em 0;padding:.1em 1em;border-left:3px solid #a1a1aa;color:#52525b}table{width:100%;border-collapse:collapse;margin:1em 0;font-size:9.5pt}th,td{border:1px solid #d4d4d8;padding:6px 8px;vertical-align:top}th{background:#f4f4f5;text-align:left}.tasks{list-style:none;padding-left:0}.task{display:flex;gap:.55em}.checkbox{display:inline-flex;width:1.1em;height:1.1em;align-items:center;justify-content:center;border:1px solid #a1a1aa;border-radius:3px;margin-top:.25em;font-size:.75em}.checked{color:#71717a;text-decoration:line-through}.asset,.attachment{display:flex;align-items:center;gap:10px;margin:1em 0;padding:10px;border:1px solid #d4d4d8;border-radius:7px;break-inside:avoid}.asset{flex-direction:column;align-items:flex-start}.asset-icon,.attachment-icon{font-size:20px;color:#71717a}.attachment small{display:block;color:#71717a;font-size:8.5pt}hr{border:0;border-top:1px solid #d4d4d8;margin:1.5em 0}mark{padding:0 .1em}
