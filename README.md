...
- `src/renderer/notesRichTextEditor.ts`: isolated Tiptap adapter with canonical-document serialization, absolute-HTTP(S)-only inert links, safe S3-image node views, revocable blob-URL ownership, and compact formatting controls
