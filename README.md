...
- `src/renderer/settingsDialog.ts`: main-process-backed MinIO/S3 Endpoint/Bucket settings, masked credential hydration, password visibility controls, automatic sync state, and explicit `Sync Now` retry/check UI
