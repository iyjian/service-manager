...
- `scripts/copy-main-runtime.cjs`: preserves shared Rich Text, Markdown/export, and Sentry-privacy CommonJS main-process runtime artifacts before renderer compilation
- `scripts/copy-renderer.cjs`: renderer static asset copy helper, including local xterm, `js-yaml`, CodeMirror, recursively resolved Tiptap and Sentry browser-ESM dependency graphs, and renderer ESM builds of shared Rich Text, Markdown/export, and privacy runtime products while restoring their main-process CommonJS counterparts
