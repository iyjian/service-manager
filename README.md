...
12. Local Clash-compatible proxy runtime:
    ...
    - Proxy Start, Stop, internal restart, and shutdown are serialized; a Stop or shutdown requested during startup runs afterward and remains authoritative, and child spawn failures surface as Proxy errors instead of uncaught process errors
