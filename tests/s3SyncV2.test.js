...
test('S3 v2 SigV4 signs query strings and DELETE requests for share management', () => {
  const list = signS3V2Request({
    method: 'GET',
...
test('S3 v2 presigned GET URLs are deterministic and capped at seven days', () => {
  const signed = presignS3V2Get({
